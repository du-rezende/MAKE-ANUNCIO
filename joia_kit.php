...
if(!is_dir($dir_img .$skuF)){
  mkdir($dir_img .$skuF, 0777, true);
...
<form id="form_upload" method="post" enctype="multipart/form-data">
  ...
  <input type="hidden" name="file_dir_base" id="file_dir_base" value="https://calcecomestilo.com/image/MKTPLACE/LADYLU/PULSEIRAS/LADYLU-PKIT/<?php echo $skuF; ?>/"/>
